...
class City(Base):
    ...
    Attributes:
        ...
        id (int): The id of the class (public) (city's id)
        name (str): The name of the class (public) (city's name)
        state_id (int): The state the city belongs to (city's state id)
