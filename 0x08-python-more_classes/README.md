...
**File - `5-rectangle.py`:** Write a class  `Rectangle`  that defines a rectangle by: (based on  `4-rectangle.py`)
...
**File - `7-rectangle.py`:** Write a class  `Rectangle`  that defines a rectangle by: (based on  `6-rectangle.py`)
